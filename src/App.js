        ...
        <div className='scene' id='welcome'>
          <article className='content'>
            ...
            <p>
              ...
              drinks, food, and good&nbsp;conversation. &nbsp;To learn more
        ...
        <div className='scene' id='hotelinfo'>
          ...
          <article id='usefulinfo'>
            <section id='arrivalinfo'>
              ...
              <ul>
                ...
                <li>
                  <strong>Parking:</strong> Self-parking in the underground
                  garage is ￡15 per day and valet-parking is ￡50 per day.
                </li>
                <li>
                ...
                <li>
                  ...
                  allowed in designated pet rooms, and the specified common
                  areas. Service animals are allowed everywhere.
                </li>
              </ul>
            </section>
            <section className='checklist' id='services'>
              ...
              <p>
                Our services and amenities are designed to make your travel
                easy, your stay comfortable, and your experience one-of-a-kind.
              </p>
              <ul>
                <li>Indoor pool</li>
          ...
          <article id='greenprogram'>
            ...
            <p>
              ...
              lighting and appliances throughout the hotel - we’re saving energy
              in every socket, outlet, and switch. We’ve also initiated a
              recycling and composting program that reduces the load to local
              landfills, while providing valuable raw material for use in new
              products, or in the case of compost, for use in local gardens and
              landscapes.
            </p>
          </article>
        </div>
